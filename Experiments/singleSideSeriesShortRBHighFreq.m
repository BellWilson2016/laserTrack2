function singleSideSeriesShortRBHighFreq() 

	global allScheduledEvents;
	allScheduledEvents = [];	% Clear existing schedule

	% Setup generic experimental info
	exp.experimentName = [datestr(now,'YYmmDD-HHMMss-'),'singleSideSeriesShortRBHighFreq'];
    exp.genotype       = 'NorpA[7]/y ; H134R / Or42a-Gal4 ; Or67b-Gal4 / +';
    exp.flyAge         = 7;    % Days
    exp.sex            = 'M';
    exp.odor           = 'none';
	...
	exp.laserPowers    =  [0,2,3,4,6,8,10,12];
	...
	exp.laserFilter    = 1;
	exp.nReps          = 8;
	exp.comment		   = '100 Hz, red thermal compensation';	
