function singleSideFreqSeries() 

	global allScheduledEvents;
	allScheduledEvents = [];	% Clear existing schedule

	% Setup generic experimental info
	exp.experimentName = [datestr(now,'YYmmDD-HHMMss-'),'singleSideFreqSeries'];
	...
	exp.laserPowers    = [0,56,156,206,236,246,251,254];
	%exp.laserPowers    = [108,162];
	exp.laserFilter    = 1;
	exp.nReps          = 8;
	exp.comment		   = 'Freq. series';	
