function openLoop4Sec() 

	global allScheduledEvents;
	allScheduledEvents = [];	% Clear existing schedule

	% Setup generic experimental info
	exp.experimentName = [datestr(now,'YYmmDD-HHMMss-'),'openLoop5Sec'];
    exp.genotype       = 'NorpA[7]/y ; ChR2/Or42b-Gal4 ; ChR2/Or22a-Gal4';
    exp.flyAge         = 12;    % Days
    exp.sex            = 'M';
    exp.odor           = 'none';
	...
	for repN = 1:exp.nReps
		...
		for seqN = 1:nSeq
			...
			exp.protocol	 = @laser_15sec_5secL_15sec;
