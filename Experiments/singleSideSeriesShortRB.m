function singleSideSeriesShortRB() 
	...
	exp.redMultiplier  = 2;
	exp.redPowers      =  [256+232,256-4+224,256-8+192,256-16+160,256-32+112,256-64+96,256-128+16,256-256];
	exp.opposingBlue   =  zeros(1,8);
	exp.opposingRed    =  [256+232,256+224,256+192,256+160,256+112,256+96,256+16,256];
	exp.laserFilter    = 1;
	exp.nReps          = 8;
